...
<html lang="en">
    <head>
        <title>AET Level 5 - Diploma in Education and Training</title>
        <meta charset="UTF-8" />
            ...
            <section class="page-header-2">
                <div class="head-bg">
                    <div class="container">
                        ...
                        <h1>AET Level 5 - Diploma in Education and Training </h1>
                        <ol class="breadcrumb">
                            <li><a href="../index.php">Home</a></li>
                            <li><a href="agdHM.php">AET Level 5 - Diploma in Education and Training</a></li>
                        </ol>
                    </div><!-- container -->
                </div><!-- head-bg -->
            </section><!-- page-header -->
