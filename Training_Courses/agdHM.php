...
<html lang="en">
    <head>
        <title>Advanced Graduate Diploma (AGD) in Hospitality Management</title>
        <meta charset="UTF-8" />
            ...
            <section class="page-header-2">
                <div class="head-bg">
                    <div class="container">
                        ...
                        <h1>Advanced Graduate Diploma (AGD) in Hospitality Management </h1>
                        <ol class="breadcrumb">
                            <li><a href="../index.php">Home</a></li>
                            <li><a href="agdHM.php">Advanced Graduate Diploma (AGD) in Hospitality Management</a></li>
                        </ol>
                    </div><!-- container -->
                </div><!-- head-bg -->
            </section><!-- page-header -->
