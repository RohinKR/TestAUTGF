...
<html lang="en">
    <head>
        <title>Postgraduate Management Executive Diploma</title>
        <meta charset="UTF-8" />
            ...
            <section class="page-header-2">
                <div class="head-bg">
                    <div class="container">
                        ...
                        <h1>Postgraduate Management Executive Diploma  </h1>
                        <ol class="breadcrumb">
                            <li><a href="../index.php">Home</a></li>
                            <li><a href="pgME.php">Postgraduate Management Executive Diploma </a></li>
                        </ol>
                    </div><!-- container -->
                </div><!-- head-bg -->
            </section><!-- page-header -->
                            ...
                            <div class="single">
                                ...
                                <div class="content" >
									...
									<li class = "h4"><i class = "fa fa-arrow-circle-right"></i><b>MED701:</b> Marketing Principles with International concepts</li>
                                        ...
                                        <li class = "h4"><i class="fa fa-arrow-circle-right"></i> <b>MED703:</b> Corporate Finance </li>
										<li class = "h4"><i class="fa fa-arrow-circle-right"></i> <b>MED704: </b> Strategic Management Techniques</li>
										...
										<li class = "h4"><i class="fa fa-arrow-circle-right"></i>  <b>MED707:</b> Global Business Strategy</li>
