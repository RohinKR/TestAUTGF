...
<html lang="en">
    <head>
        <title>Advanced Graduate Diploma (AGD) in Business Management</title>
        <meta charset="UTF-8" />
            ...
            <section class="page-header-2">
                <div class="head-bg">
                    <div class="container">
                        ...
                        <h1>Advanced Graduate Diploma (AGD) in Business Management </h1>
                        <ol class="breadcrumb">
                            <li><a href="../index.php">Home</a></li>
                            <li><a href="agdBM.php">Advanced Graduate Diploma (AGD) in Business Management</a></li>
                        </ol>
                    </div><!-- container -->
                </div><!-- head-bg -->
            </section><!-- page-header -->
                            ...
                            <div class="single">
                                ...
                                <div class="content" >
									...
									<li class = "h4"><i class = "fa fa-arrow-circle-right"></i><b>IT501:</b> Introduction to Information Technology</li>
                                        ...
                                        <li class = "h4"><i class="fa fa-arrow-circle-right"></i> <b>BM511:</b>Consumer Behaviour</li>
										<li class = "h4"><i class="fa fa-arrow-circle-right"></i> <b>BM512: </b> Human Resources Management</li>
                                        <li class = "h4"><i class="fa fa-arrow-circle-right"></i> <b>BM513: </b> Management of Change  </li>
                                        <li class = "h4"><i class="fa fa-arrow-circle-right"></i> <b>BM514:</b>  New Venture Creation and Entrepreneurial Studies</li>
										<li class = "h4"><i class="fa fa-arrow-circle-right"></i>  <b>BM515:</b> Strategic Management</li>
